...
const permission = [
  { id: 1, permission: "Create a new user" },
  { id: 2, permission: "Edit user" },
  { id: 3, permission: "Send message" },
  { id: 4, permission: "Export medical report" },
  { id: 5, permission: "Export basic information" },
  { id: 6, permission: "View medical record" },
  { id: 7, permission: "Edit medical record" },
  { id: 8, permission: "Delete user" },
];
const reports = [
  { id: 1, reports: "View medical reports" },
  { id: 2, reports: "View country reports" },
  { id: 3, reports: "Export reports" },
];
